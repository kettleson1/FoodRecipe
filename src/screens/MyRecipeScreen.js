...
const styles = StyleSheet.create({
  ...
  addButton: {
    backgroundColor: "#4F75FF", padding: wp(2), alignItems: "center",
    borderRadius: 5, width: 300, marginLeft: "auto", marginRight: "auto"
  },
  addButtonText: { color: "#fff", fontWeight: "600", fontSize: hp(2.2) },
  scrollContainer: {
    paddingBottom: hp(2), alignItems: "center", justifyContent: "center",
    flexDirection: "row", flexWrap: "wrap"
  },
  norecipesText: {
    textAlign: "center", fontSize: hp(2),
    color: "#6B7280", marginTop: hp(5)
  },
  recipeCard: {
    width: 400, height: 300, backgroundColor: "#fff",
    padding: wp(3), borderRadius: 8, marginBottom: hp(2),
    shadowColor: "#000", shadowOpacity: 0.1, shadowRadius: 4,
    shadowOffset: { width: 0, height: 2 }, elevation: 3
  },
  recipeImage: { width: 300, height: 150, borderRadius: 8, marginBottom: hp(1) },
  ...
  editButton: { backgroundColor: "#34D399", padding: wp(2), borderRadius: 5, width: 100, alignItems: "center" },
  editButtonText: { color: "#fff", fontWeight: "600", fontSize: hp(1.8) },
  deleteButton: { backgroundColor: "#EF4444", padding: wp(2), borderRadius: 5, width: 100, alignItems: "center" },
